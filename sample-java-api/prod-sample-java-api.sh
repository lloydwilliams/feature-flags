...
exec java -javaagent:./dd-java-agent.jar -Ddd.logs.injection=true -Ddd.runtime.metrics.enabled=true -Ddd.service=sample-app -Ddd.env=prod -Ddd.version=2.0.0 -jar "$JAR"
